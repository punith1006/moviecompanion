...
import { Play, Loader2, Mail, Lock, User } from "lucide-react";
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-sm text-[#a09dab]">Name</label>
                            <div className="relative">
                                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6b6873]" />
                                <Input
                                    {...register("name")}
                                    type="text"
                        ...
                        <div className="space-y-2">
                            <label className="text-sm text-[#a09dab]">Confirm Password</label>
                            <div className="relative">
                                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6b6873]" />
                                <Input
